...
This skill is the single owner of Number One's bug-diagnosis reasoning procedure.
Number One applies it when briefing delegated investigation and evaluating the resulting evidence, without taking over project-specific investigation itself.
